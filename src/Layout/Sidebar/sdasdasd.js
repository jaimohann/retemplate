...
const StyledContainer = styled.div`
  ...
  @media (max-width: 1920px) {
    width: ${({ collapse,menuLink }) => (collapse ? "5rem" : menuLink ? "14.125rem" : "15.625rem")};
  }
  ...
  @media (max-width: 480px) {
    width: ${({ collapse,menuLink }) => (collapse ? "0" : menuLink ? "14.125rem" : "15.625rem")};
  }
  &:hover {
